...
* display.c
*
* Created: 11/05/2019 11:19:26 PM
*  Author: liam
*/
...
const pin_t data_pins[] = {pd5, pd6, pd7, pb0, pc0, pc1, pc2, pc3};
...
void display_console_write(int col, int row, char* string) {
	...
	//if on an odd column, need to append a space since addresses only point to even columns
	if(col % 2) {
